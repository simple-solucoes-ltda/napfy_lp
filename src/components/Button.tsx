...
const variantStyles = {
  solid: {
    ...
    orange: 'bg-[#FA923B] text-white hover:bg-[#FA923B]/90 active:bg-[#FA923B] active:text-white/80',
  },
  outline: {
    gray: 'border-gray-300 text-gray-700 hover:border-gray-400 active:bg-gray-100 active:text-gray-700/80',
    orange: 'border-[#FA923B] text-[#FA923B] hover:bg-[#FA923B]/10 active:bg-[#FA923B]/20',
  },
}
